...
LIBS = -lSDL2 -lpng
CC = g++
SRC = main.cpp Mesh.cpp Object.cpp obj_read.cpp Quaternion.cpp Window.cpp Object.cpp Render.cpp Scene.cpp Light.cpp PointLight.cpp DirectionalLight.cpp Image.cpp
